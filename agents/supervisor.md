...
- Watchdog consumes retrospector's recommendation queue (`docs/operations/retrospector-recommendations.jsonl`) and applies pending entries to BOARD.md Needs Decision section via governed PRs
