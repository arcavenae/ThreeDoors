...
- [ ] Create `arcaven/homebrew-tap` repository on GitHub (shared tap — requires repo owner)
...
- [x] README already has Homebrew install instructions (`brew install arcaven/tap/threedoors`)
