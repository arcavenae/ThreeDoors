...
- [x] Add Daily Planning Mode feature bullet (Epic 27)
- [x] Add Seasonal Themes feature bullets and update theme table to 8 entries (Epic 33)
- [x] Add Door-Like Visuals feature bullet (Epic 35)
- [x] Add Selection Feedback feature bullet (Epic 36)
- [x] Add Beautiful Statistics feature bullets — sparklines, heatmaps, milestone celebrations (Epic 40)
- [x] Add Charm Ecosystem / huh forms mention (Epic 41)
- [x] Add `:seasonal` command to Command Palette table
- [x] Reorganize features into clear categories with emoji headers
- [x] Verify all feature descriptions match actual shipped implementation
