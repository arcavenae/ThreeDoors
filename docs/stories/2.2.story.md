...
3. **Spike report exists with formal recommendation:**
   ...
   - Then a spike report exists at `../../_bmad-output/planning-artifacts/apple-notes-integration-spike.md`
...
- Spike report at `../../_bmad-output/planning-artifacts/apple-notes-integration-spike.md` with completed comparison matrix
...
- [ ] Task 5: Create comparison matrix and spike report (AC: 3)
  - [ ] 5.1: Create `../../_bmad-output/planning-artifacts/apple-notes-integration-spike.md` with:
    - Executive summary
    - Comparison matrix:
...
The report at `../../_bmad-output/planning-artifacts/apple-notes-integration-spike.md` must contain these sections (validated by `scripts/spike/tests/validate_report.sh`):
- [ ] Executive Summary
...
- Spike report goes in `_bmad-output/planning-artifacts/` (consolidated from former `docs/spike-reports/`)
