...
**And** the URL targets `arcavenae/ThreeDoors` with title and body as query parameters
...
- Browser URL construction in `internal/tui/bug_report.go`:
  - Format: `https://github.com/arcavenae/ThreeDoors/issues/new?title=...&body=...&labels=type.bug`
