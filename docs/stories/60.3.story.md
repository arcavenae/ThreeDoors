...
- [x] Wrap Key Bindings section in `<details><summary>`
- [x] Wrap CLI Reference section in `<details><summary>`
- [x] Wrap Provider Configuration / Config Reference in `<details><summary>`
- [x] Wrap MCP Server section in `<details><summary>`
- [x] Wrap Development section in `<details><summary>`
- [x] Wrap Data Directory section in `<details><summary>`
- [x] Verify all sections expand/collapse correctly on GitHub
- [x] Verify markdown renders correctly inside `<details>` blocks (tables, code blocks, headers)
- [x] Verify TOC anchor links still work for folded sections
- [x] Add "↑ Back to top" links after each major section
