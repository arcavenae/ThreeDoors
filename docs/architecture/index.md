...
- [ThreeDoors Architecture Document](#table-of-contents)
  ...
  - [Agent Governance](./agent-governance.md)
    - [Agent Interaction Architecture](./agent-governance.md#1-agent-interaction-architecture)
    - [Communication Protocol](./agent-governance.md#2-communication-protocol)
    - [Authority Boundaries](./agent-governance.md#3-authority-boundaries)
    - [Anti-Patterns and Safeguards](./agent-governance.md#4-anti-patterns-and-safeguards)
    - [Resource Budget and Scaling](./agent-governance.md#5-resource-budget-and-scaling)
    - [Lifecycle Management](./agent-governance.md#6-lifecycle-management)
